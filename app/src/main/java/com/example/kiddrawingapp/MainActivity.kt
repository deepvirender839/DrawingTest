...
class MainActivity : AppCompatActivity() {
    ...
    private var imgBrush: ImageButton? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mImgButtonCurrentPaint = linerLayoutPaintColors[3] as ImageButton

        imgBrush = findViewById(R.id.ib_brush)
    ...
    private fun showBrushSizeChooserDialog() {
        ...
        val smallBtn = brushDialog.findViewById<ImageButton>(R.id.ibBRushSize)
    ...
    fun paintClicked(view: View) {
        if (mImgButtonCurrentPaint !== view) {
